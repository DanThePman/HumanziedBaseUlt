...
namespace HumanziedBaseUlt.DamageCalculation
{
    /// <summary>
    ...
    public class DamageSpell
    {
        ...
        ///     The damage type
        /// </summary>
        public DamageEx.DamageType DamageType;
    ...
    public static class DamageEx
    {
        ...
        /// <summary>
        ///     Initializes static members of the <see cref="DamageEx" /> class.
        /// </summary>
        static DamageEx()
        {
            ...
            {
                ChampionName = "Fizz",
                IsActive = (source, target) => source.Spellbook.GetSpell(SpellSlot.W).Level > 0,
            ...
            {
                ChampionName = "Kayle",
                IsActive = (source, target) => source.Spellbook.GetSpell(SpellSlot.E).Level > 0,
                GetDamage = (source, target) => source.GetSpellDamage(target, SpellSlot.E)
            };
            ...
            p = new PassiveDamage
            {
                ...
                IsActive = (source, target) => source.Spellbook.GetSpell(SpellSlot.R).Level > 0,
                GetDamage = (source, target) => source.GetSpellDamage(target, SpellSlot.R)
            };
	    ...
	    */
        ...
        {
            if (EloBuddy.SDK.Constants.AutoAttacks.IsAutoAttack(spellName))
            {
            ...
            DamageType damageType)
        {
            ...
            if (targetHero != null)
            {
                ...
                {
                    var closebyenemies =
                        EntityManager.Heroes.Enemies.Any(x => x.NetworkId != target.NetworkId && x.Distance(target) <= 500);
